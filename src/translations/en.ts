const en = {
  ...
  dashboard: {
    ...
    adSlots: "Ad Slots",
    adSlotsDesc: "Community sponsor images displayed in the right rail",
    noAdSlotsConfigured: "No sponsor slots configured.",
    adSlotCount: (count: number) => `${count} slot${count !== 1 ? "s" : ""}`,
    addSlot: "+ Add Slot",
    idLabel: "ID",
