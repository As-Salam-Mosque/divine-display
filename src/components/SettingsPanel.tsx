  ...
  return (
    <>
      ...
      <div
        ...
        className={`fixed z-50 inset-x-4 top-[5vh] md:inset-auto md:top-1/2 md:left-1/2 md:-translate-x-1/2 md:-translate-y-1/2 w-auto md:w-[480px] max-h-[88vh] flex flex-col bg-surface-panel border border-primary/25 rounded-2xl shadow-[0_8px_60px_rgba(0,0,0,0.8),0_0_0_1px_rgba(233,193,118,0.08)] transition-all duration-300 ${
          isOpen
