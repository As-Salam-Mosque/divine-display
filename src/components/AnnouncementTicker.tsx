...
export function AnnouncementTicker() {
  ...
  return (
    <footer className="w-full flex items-center px-4 md:px-6 lg:px-margin-page tv:px-margin-page h-12 sm:h-14 md:h-16 tv:h-20 border-t border-primary-20 bg-surface-panel overflow-hidden shrink-0">
      {/* Label */}
      ...
      <div className="flex-1 overflow-hidden ml-4">
        <div className="flex items-center h-full gap-6 md:gap-8 lg:gap-12 font-body-md text-body-md lg:text-body-lg tv:text-body-lg leading-tight text-text-muted whitespace-nowrap animate-marquee">
          {items.map((text, i) => (
            <p
              key={i}
